...
function menu_click() {
  for (
    var e = document.querySelectorAll(".pc-navbar li"), t = 0;
    t < e.length;
    t++
  )
    e[t].removeEventListener("click", function () { });
  for (
    e = document.querySelectorAll(".pc-navbar li:not(.pc-trigger) .pc-submenu"),
    t = 0;
    t < e.length;
    t++
  )
  ...
  for (
    ...
    r[o].addEventListener("click", function (e) {
      ...
      if (
        (t =
          "SPAN" == t.tagName ? t.parentNode : t).parentNode.classList.contains(
            "pc-trigger"
          )
      )
        ...
        for (
          var r = document.querySelectorAll("li.pc-trigger"), o = 0;
          o < r.length;
          o++
        ) {
          var a = r[o];
  ...
  for (
    ...
    a[o].addEventListener("click", function (e) {
      ...
      if (
        ...
        for (
          var r = t.parentNode.parentNode.children, o = 0;
          o < r.length;
          o++
        ) {
          var a = r[o];
          a.classList.remove("pc-trigger"),
            (a =
              "LI" == a.tagName
                ? a.children[0]
                : a).parentNode.classList.contains("pc-hasmenu") &&
            slideUp(a.parentNode.children[1], 200);
        }
        t.parentNode.classList.add("pc-trigger");
    ...
    ((e = document.createElement("script")),
      "horizontal" === t
        ...
        : "color-header" === t
          ...
          : "compact" === t
            ? ((e.src = "../assets/js/layout-compact.js"),
              document.body.appendChild(e))
            : "tab" === t &&
            ((e.src = "../assets/js/layout-tab.js"),
              document.body.appendChild(e))),
    null === t &&
...
for (
  var elem = document.querySelectorAll(".pc-sidebar .pc-navbar a"), l = 0;
  l < elem.length;
  l++
) {
  var pageUrl = window.location.href.split(/[?#]/)[0];
  elem[l].href == pageUrl &&
    "" != elem[l].getAttribute("href") &&
...
for (
  var tc = document.querySelectorAll(".prod-likes .form-check-input"), t = 0;
  t < tc.length;
  t++
) {
  var prod_like = tc[t];
...
for (
  tc = document.querySelectorAll(".auth-main.v2 .img-brand"), t = 0;
  t < tc.length;
  t++
)
